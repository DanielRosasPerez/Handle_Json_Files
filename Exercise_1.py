...
"""
IN ORDER TO OPEN THE RESULTING FILE, PLEASE, MAKE RIGHT CLICK ON THE RESULTING FILE, THEN, GO TO PROPERTIES AND SPECIFY DIRECTLY THAT YOU WANT TO OPEN THIS FILE 
USING "EXCEL". IF YOU DON'T WANT TO DO THAT YOU CAN OPEN IT WITH "NOTEPAD". Thank you :)
"""
